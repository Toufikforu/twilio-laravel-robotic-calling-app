        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header justify-content-between d-flex">
                    <h3>Manual Email Sending</h3>
                       
                </div>

                <div class="card-body p-4">                            
                    <form id="emailForm" action="{{route('sendingManualForm')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="summernote" name="message" rows="4" placeholder="Your Message" class="form-control" required></textarea>
                        </div>
